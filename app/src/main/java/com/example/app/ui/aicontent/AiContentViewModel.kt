...
import com.example.app.network.AuraFxContentApiClient
...
class AiContentViewModel @Inject constructor(
    ...
    // UI states
    private val _textGenerationState = MutableStateFlow<TextGenerationState>(TextGenerationState.Idle)
    val textGenerationState: StateFlow<TextGenerationState> = _textGenerationState

    private val _imageDescriptionState = MutableStateFlow<ImageDescriptionState>(ImageDescriptionState.Idle)
    ...
    fun generateImageDescription(imageUrl: String, context: String? = null) {
        ...
        viewModelScope.launch {
            try {
                ...
                _imageDescriptionState.value = ImageDescriptionState.Error(e.message ?: "Unknown error")
            }
        }
    }
